...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '3172898eb742482f811a3ff7db28f49',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || "Hi, I'm a bug hunter, Hi, I'm a coffee guzzler, Hi, I'm a code whisperer, Hi, I'm a pixel pusher, Welcome to my digital haven!",

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tianqi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "I'm currently working in a lab focused on computer vision projects powered by machine learning.", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-olive-five-36.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yaotianqi6666@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Tianqi-Yao', // 你的github个人主页 例如 https://github.com/tangly1024
